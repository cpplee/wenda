...
URL = 'http://localhost/wenda/index.php/Index/Member/my_level/uid/14';
...
ACTION = 'http://localhost/wenda/index.php/Index/Member/my_level';
...
HISTORY = 'http://localhost/wenda/index.php/Index/Member/my_gold/uid/14';
</script>
...
<!-- 左侧结束 -->
		...
		<div id='right'>
			...
			<p class='lv-info'>恭喜您，已经升到 <span>Lv<?php echo $level;?></span> 级啦，距下一级还需 <span><?php echo $nextExp;?></span> 经验值!</p>
			<div class='lv-rule'>
				<p><span>等级规则</span></p>
				<table class='lv-exp'>
					<tr>
