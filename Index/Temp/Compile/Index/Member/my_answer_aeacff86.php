...
URL = 'http://localhost/wenda/index.php/Index/Member/my_answer/uid/14';
...
ACTION = 'http://localhost/wenda/index.php/Index/Member/my_answer';
...
HISTORY = 'http://localhost/wenda/index.php/Index/Member/my_level/uid/14';
</script>
...
<!-- 左侧结束 -->
		<div id='right'>
			...
			<ul class='ask-filter'>
				<li     <?php if($_GET['w']<>1){ ?>class='cur'<?php } ?>><a href="<?php echo U('Member/my_answer',array('uid'=>$_GET['uid']));?>"> 全部回答</a></li>
				<li     <?php if($_GET['w']==1){ ?>class='cur'<?php } ?>><a href="<?php echo U('Member/my_answer',array('uid'=>$_GET['uid'],'w'=>1));?>">被采纳的回答</a></li>
			</ul>
        ...
        if (empty($answer)) {
            ...
            foreach ($answer as $d) {
                ...
                ?>
						<tr>
							<td class='t1'>
								<a href=""><?php echo $d['askc'];?></a><span>[<?php echo $d['title'];?>]</span>
							</td>
