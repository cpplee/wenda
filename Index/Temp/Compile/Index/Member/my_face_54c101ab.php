...
URL = 'http://localhost/wenda/index.php/Index/Member/my_face/uid/14';
...
ACTION = 'http://localhost/wenda/index.php/Index/Member/my_face';
...
<script type="text/javascript"  src="http://localhost/wenda/Index/Index/View/Public/Js/validate.js"></script>
	...
	<link rel="stylesheet" href="http://localhost/wenda/Index/Index/View/Public/Css/face.css">
...
<div id='left'>
    ...
    <ul>
        <li class='myhome     <?php if($flag=='index' ){ ?>cur</ul>'>
        ...
        <li class='myface <if value="$flag eq 'my_face' ">cur<?php } ?>'>
...
<!-- 左侧结束 -->
		<div id='right'>
			...
			<div class='imgface_box'>
				...
				<form action="<?php echo U('my_face',array('uid'=>$_GET['uid']));?>" enctype="multipart/form-data" method="POST">
